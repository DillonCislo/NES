...
public:
    ...
    inline int minimize(Foo& f, Vector& x, Scalar& fx)
    {
        ...
        // Handle Infs produces by the initial guess
        ...
        for( ; ; )
        {
            ...
            try {
              ...
              LineSearch<Scalar>::LineSearch(f, fx, x, m_grad, step,
                  m_drt, m_xp, m_param);
        ...
        std::cout << "IT SHOULD NOT BE POSSIBLE TO SEE THIS MESSAGE" << std::endl;
        return k;
    }
};
